...
typedef enum {
    RSSKS_STATUS_CODE_SUCCESS,
    RSSKS_STATUS_CODE_NO_SOLUTION,
    
    RSSKS_STATUS_CODE_PF_UNKNOWN,
    RSSKS_STATUS_CODE_PF_ALREADY_LOADED,
    RSSKS_STATUS_CODE_PF_INCOMPATIBLE,

    RSSKS_STATUS_CODE_OPT_UNKNOWN,
    
    RSSKS_STATUS_CODE_FAILURE
} RSSKS_status_code;
