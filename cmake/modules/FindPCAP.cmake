...
if (PCAP_INCLUDE_DIR)
    message(STATUS "Found PCAP include path: \"${PCAP_INCLUDE_DIR}\"")
else()
    message(STATUS "Could not find PCAP include path")
endif()
...
if (PCAP_LIBRARIES)
    message(STATUS "Found PCAP libraries: \"${PCAP_LIBRARIES}\"")
else()
    message(STATUS "Could not find PCAP libraries")
endif()
